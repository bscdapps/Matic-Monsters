...
export const getMOONLIGHTBalance = async (web3, contract, account) => {
  const response = await contract.methods.balanceOf(account).call();
  return web3.utils.fromWei(response, "ether").toString();
};

export const getBeastMOONLIGHTAllowance = async (web3, contract, account) => {
...
export const setBeastMOONLIGHTApprove = async (web3, contract, account) => {
  const response = await contract.methods
    .approve(
      getBeastAddress(),
...
export const getMOONLIGHTAmountToMintBeast = async (
  web3,
  contract,
  amount
) => {
  const response = await contract.methods.getMOONLIGHTAmount(amount).call();
  return response;
};
...
export const getWarriorMOONLIGHTAllowance = async (
  web3,
  contract,
  account
) => {
...
export const setWarriorMOONLIGHTApprove = async (web3, contract, account) => {
  const response = await contract.methods
    .approve(
      getWarriorAddress(),
      web3.utils.toWei("1000000000", "ether").toString()
...
export const getMOONLIGHTAmountToMintWarrior = async (
  web3,
  contract,
  amount
) => {
...
export const getLegionMOONLIGHTAllowance = async (web3, contract, account) => {
  const response = await contract.methods
...
export const setLegionMOONLIGHTApprove = async (web3, contract, account) => {
  const response = await contract.methods
    .approve(
      getLegionAddress(),
      web3.utils.toWei("1000000000", "ether").toString()
...
export const setMarketplaceMOONLIGHTApprove = async (
  web3,
  contract,
  account
) => {
...
export const getMarketplaceMOONLIGHTAllowance = async (
  web3,
  contract,
  account
) => {
