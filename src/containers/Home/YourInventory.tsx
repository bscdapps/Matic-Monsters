...
const YourInventory = () => {
    ...
    const [MLTBalance, setMLTBalance] = React.useState("0");
    ...
    const getBalance = async () => {
        ...
        const MLTBalance = await getMOONLIGHTBalance(
            web3,
            MOONLIGHTContract,
            account
        );
        setMLTBalance(MLTBalance);
    };
        ...
        >
            <Box sx={{ p: 4, justifyContent: "center" }}>
                ...
                <Typography
                    ...
                    sx={{ fontWeight: "bold" }}
                >
                    {getTranslation("MLTInYourWallet")}:<span className="legionOrangeColor">{" "}
                        {formatNumber(parseFloat(MLTBalance).toFixed(2))} ( = xx USD )</span>
                </Typography>
                <Typography
                    className="legionFontColor"
                    variant="subtitle1"
                    sx={{ fontWeight: "bold" }}
                >
                    1 USD = <span className="legionOrangeColor">xx $MLT</span>
                </Typography>
                <Typography
                    className="legionFontColor"
                    variant="subtitle1"
                    sx={{ fontWeight: "bold" }}
                >
                    1 MLT = <span className="legionOrangeColor">xx USD</span>
                </Typography>
            </Box>
        </Card>
    );
