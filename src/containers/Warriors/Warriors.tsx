...
import { getWarriorMOONLIGHTAllowance, setWarriorMOONLIGHTApprove, mintWarrior, getWarriorBalance, getWarriorTokenIds, getWarriorToken, sellToken, setMarketplaceApprove, getBaseUrl, execute, getMOONLIGHTAmountToMintWarrior, getFee } from '../../hooks/contractFunction';
import { useMOONLIGHT, useWarrior, useMarketplace, useLegion, useFeeHandler, useWeb3 } from '../../hooks/useContract';
...
const Warriors = () => {
	...
	const handleMint = async (amount: Number) => {
		...
		setMintLoading(true);
		setLoading(false);
		const allowance = await getWarriorMOONLIGHTAllowance(web3, MOONLIGHTContract, account);
		try {
			if (allowance === '0') {
				await setWarriorMOONLIGHTApprove(web3, MOONLIGHTContract, account);
			}
