...
import {
  getLegionMOONLIGHTAllowance,
  setLegionMOONLIGHTApprove,
  getWarriorTokenIds,
  getWarriorToken,
...
const CreateLegions: React.FC = () => {
  ...
  const handleMint = async () => {
    setMintLoading(true);
    const allowance = await getLegionMOONLIGHTAllowance(
      web3,
      MOONLIGHTContract,
      account
    );
    if (allowance === "0") {
      await setLegionMOONLIGHTApprove(web3, MOONLIGHTContract, account);
    }
    try {
      await mintLegion(
        web3,
          ...
          >
            ...
            <Grid item xs={6}>
              ...
              >
                ...
                >
                  {isSmallThanSM
                    ? getTranslation("ShortFeeToolTip") + mintFee + " $MLT"
                    : getTranslation("LongFeeToolTip") + mintFee + " $MLT"}
                </Grid>
