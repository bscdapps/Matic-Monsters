		...
		<Box>
			...
			<Dialog onClose={handleSupplyClose} open={openSupply}>
				...
				<List sx={{ pt: 0 }}>
					...
					>
						<ListItemText primary={`7 Hunts (${selectedLegion === -1 ? 0 : legions.filter((item) => parseInt(item.id) === selectedLegion)[0]['warriors'].length * 7} $MLT)`} />
					</ListItem>
					<ListItem
						button
						sx={{ textAlign: "center" }}
					...
					>
						<ListItemText primary={`14 Hunts (${selectedLegion === -1 ? 0 : legions.filter((item) => parseInt(item.id) === selectedLegion)[0]['warriors'].length * 13} $MLT)`} />
					</ListItem>
					<ListItem
						button
						sx={{ textAlign: "center" }}
					...
					>
						<ListItemText primary={`28 Hunts (${selectedLegion === -1 ? 0 : legions.filter((item) => parseInt(item.id) === selectedLegion)[0]['warriors'].length * 24} $MLT)`} />
					</ListItem>
				</List>
			</Dialog>
