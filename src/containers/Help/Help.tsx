...
const Help = () => {
  ...
  const replyEmailForm = (id: any, discordId: any) => {
    return (
      ...
      '<p>- Simple video instructions on how to play Crypto Legions: <a href="https://bongy-extoic.gitbook.io/maticmonsters/how-to-get-started" target="_blank">https://bongy-extoic.gitbook.io/maticmonsters/how-to-get-started</a></p>' +
