...
const AppBarComponent = () => {
    ...
    const getBalance = async () => {
        setBalance(
            await getMOONLIGHTBalance(web3, MOONLIGHTContract, account)
        );
            ...
            >
                <DialogTitle>
                    {taxLeftDays !== "0"
                        ...
                        : `Claim ${unClaimedUSD.toFixed(2)} $MLT`}
                </DialogTitle>
                <DialogContent>
                    <DialogContentText id="alert-dialog-slide-description">
                        {unClaimedUSD === 0 ? (
                            <>
                                There is no $MLT to claim.
                                <br />
                                Please hunt monsters to get $MLT.
                            </>
                        ) : taxLeftDays === "0" ? (
                            <>
                                ...
                                $MLT tax-free.
                                <br />
                                You will receive {unClaimedUSD.toFixed(2)} $MLT
                                in your wallet.
                                <br />
                            ...
                            <>
                                You are about to claim {unClaimedUSD.toFixed(2)}{" "}
                                $MLT with {2 * parseInt(taxLeftDays)}% tax.
                                <br />
                                You will pay{" "}
                                {(
